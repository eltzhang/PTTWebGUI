...
<link
	href="<c:url value="/resources/css/message_center.css" />"
	title="default" rel="stylesheet" type="text/css" />
...
<body class="layoutBase" onbeforeunload="beforeUnload()">
	...
	<div id="interfaceBlocker"
		...
		<div style="vertical-align: middle; top: 40%; position: absolute;">
			<img src="<c:url value="/resources/images/interface/ajax-loader-big.gif" />" alt="loading..">
		</div>
	</div>
		...
		<div id="header">
			<div id="left">
				<a href="/worker_desktop.do"><img
					src="<c:url value="/resources/images/logos/TELUS-logo.svg" />" border=0 alt="Home"></a> <span
			...
			<div class="contentWrapper">
				...
				<ul id="listpanlink" class="clearfix emptyCell ">
					<li class="listLink fr"><a tabIndex="0" class="helpLink"
						...
						href="javascript:openOnlineHelp(0, 'message_center')">Page
							Help</a></li>
				</ul>
				<div class="badge clearfix">
					<h1>
						<div class="titleheaderpan fl list_notification">Control Panel</div>
					</h1>
				</div>
							...
							<tr>
								<td class="mcLeftCell">
									<div id="mcLeftPanel">
										<div style="padding: 0px 16px 12px 16px">
											<div>
												<div class="mc_label">
													<label for="message_center_list_subject_sch">Subject</label>
												</div>
												...
												<div class="formElementInstruction"
													...
													'Enter' or click 'Filter Messages'.</div>
											</div>

										</div>
										<div style="padding: 12px 16px; border-top: 1px solid #d3e3ed">
											<div class="mc_label">Message Type</div>
											<div style="margin-bottom: 6px">
												<span tabIndex="0" class="actionLink actionLinkText pr12px"
													role="link" onclick="selectAllTypes()"
													style="border-right: 1px solid #dcdcdc">Select All</span>
												<span tabIndex="0" class="actionLink actionLinkText"
													role="link" onclick="deSelectAllTypes()">Select None</span>
											</div>
													...
													<div class="blueBox clearfix">
														<div class="fl">
															<input type="checkbox" class="notificationTypeChk"
																...
																checked><label for="showNotification">Notification</label>
													...
													<div class="blueBox clearfix">
														<div class="fl">
															<input type="checkbox" class="notificationTypeChk"
																...
																checked><label for="showBroadcast">Broadcast</label>
										...
										<div style="padding: 12px 16px; border-top: 1px solid #d3e3ed">
											<div class="mc_label">Message Status</div>
											<div style="margin: 8px 0">
												<input type="checkbox" name="messageStatus" value="28"
													id="readMessages" checked><label for="readMessages">Unread</label>
											</div>
											<div>
												<input type="checkbox" name="messageStatus" value="29"
													id="unReadMessages" checked><label
													for="unReadMessages">Read</label>
											</div>
										</div>
										<div
											style="padding: 16px 16px; border-top: 1px solid #d3e3ed;">
											<div class="">
												<input type="submit" class="listButton"
													enableAfterLoad="yes" value="Filter Messages"
													name="message_center_list_search">
											</div>
										</div>
									</div>
								...
								<td>
									...
									<div class="listcontrol2 clearfix">
										<span class="listcontrol2Inner"><span class="title">Messages</span></span><span
											class="fr"><span style="line-height: 25px;">Items
												Found: </span><span class="filter itemsCount pl5px "
									...
									<table style="width: 100%; table-layout: fixed; border: 0px"
										...
										<tr>
											<td style="padding: 0px"><div
													...
													<table id="listheaderTable_message_center_list"
														class="list">
														<colgroup>
														...
														<thead>
															<tr>
																...
																<th class="listTopBorder" id="message_center_list_row_9"
																	style="padding: 0px"></th>
																<th class="listTopBorder"
																	id="message_center_list_row_10" style="padding: 0px"></th>
																<th class="listTopBorder"
																	id="message_center_list_row_11" style="padding: 0px"></th>
																<th class="listTopBorder"
																	id="message_center_list_row_12" style="padding: 0px"></th>
																<th class="listTopBorder"
																	id="message_center_list_row_13" style="padding: 0px"></th>
																<th class="listTopBorder"
																	id="message_center_list_row_14" style="padding: 0px"></th>
															</tr>
															<tr>
																<th></th>
																...
																<th><span class="clickable"
																	...
																	onclick="setFormValue('cSelForm', 'message_center_list_st', 'a'); setFormValue('cSelForm', 'message_center_list_s', 'creator_name');  submitForm('cSelForm'); ">From</span></th>
																<th class="columnDivider"
																	title="Drag&#x20;to&#x20;resize"><div
																		ondragstart="return false" class="listColumnSeperator"
																...
																<th><span class="clickable"
																	title="Click&#x20;to&#x20;sort" role="link"
																	onclick="setFormValue('cSelForm', 'message_center_list_st', 'a'); setFormValue('cSelForm', 'message_center_list_s', 'subject');  submitForm('cSelForm'); ">Subject</span></th>
																<th class="columnDivider"
																	title="Drag&#x20;to&#x20;resize"><div
																		ondragstart="return false" class="listColumnSeperator"
																...
																<th style="text-align: right;"><span
																	class="clickable" title="Click&#x20;to&#x20;sort"
																	role="link"
																	onclick="setFormValue('cSelForm', 'message_center_list_st', 'a'); setFormValue('cSelForm', 'message_center_list_s', 'date');  submitForm('cSelForm'); ">Received</span></th>
																<th class="columnDivider"
																	title="Drag&#x20;to&#x20;resize"><div
																		ondragstart="return false" class="listColumnSeperator"
														...
														<tbody>
															<tr class="evenRow">
																...
																<td id="notification_btn_z16030421473844727167908"
																	colspan="2"><nobr>
																		<div class=" notificationType broadcastColor">Broadcast</div>
																	</nobr></td>
																<td colspan="2"><nobr>Agent, Fieldglass</nobr></td>
																<td colspan="2"><nobr>Alert!</nobr></td>
																<td colspan="2" style="text-align: right;"><nobr>2016-03-05
																		04:47</nobr></td>
																<td></td>
															</tr>
															<tr class="oddRow">
																<td class="first" colspan="2"><nobr>29</nobr></td>
																<td colspan="2" class=" checkpan "><input
																	type="checkbox" name="cSelCheckBox"
																	value="z16030421413693155304908"
																	onclick="onClickCheckMarkList(event)"
																	aria-label="z16030421413693155304908"></td>
																<td colspan="2"><nobr>z16030421413693155304908</nobr></td>
																<td id="notification_btn_z16030421413693155304908"
																	colspan="2"><nobr>
																		<div class=" notificationType broadcastColor">Broadcast</div>
																	</nobr></td>
																<td colspan="2"><nobr>Agent, Fieldglass</nobr></td>
															...
															<tr class="evenRow">
																<td class="first" colspan="2">29</td>
																<td colspan="2" class=" checkpan "><input
																	type="checkbox" name="cSelCheckBox"
																	value="z16030422414449317603913"
																	onclick="onClickCheckMarkList(event)"
																	aria-label="z16030422414449317603913"></td>
																<td colspan="2">z16030422414449317603913</td>
																<td id="notification_btn_z16030422414449317603913"
																	colspan="2"><div
																		class=" notificationType notificationColor">Notification</div></td>
																<td colspan="2">Sheng, Benjamin (Wenbo)</td>
																<td colspan="2" style="height: 33;"><span
																	style="padding: 0px"
																	title="TERM: Time Sheet completely approved [Worker Name: Zhang, Yongqiang, Time Sheet Start Date: 2016-02-28, Time Sheet End Date: 2016-03-05, Time Sheet ID: TLUSTS00397428]">TERM:
																		Time Sheet completely approved [Worker Name: Zhang,
																		Yongqiang, Time Sheet Start Date: 2016-02-...</span></td>
																<td colspan="2" style="text-align: right;">2016-03-04
																	17:41</td>
																<td></td>
															</tr>
														</tbody>
									...
									<div class="listFooter clearfix">
										<span class="fl"><span class="listFooterItem"><span>Data
											...
											onclick="setFormValue('cSelForm', 'message_center_list_refresh', 'true'); submitForm('cSelForm');"><span
												...
												type="hidden" name="message_center_list_refresh"></span> <span
...
calculateCheckmarksCount('cSelCheckBox');
		...
		<div id="disclaimer">
			<div class="footerLeft">
				...
				<div class="cl">
					Confidential and Proprietary Information of SAP Fieldglass, Inc.<br />
			...
			<div class="footerRight">
				SAP Fieldglass November 2015 | fas-05 prod1<br />&copy; 2016 SAP SE
...
<body>
	...
	<c:if test="${not empty files}">
		...
		<table border="1px" bordercolor="black" width=80% align="center">
			<tr>
				<td align="center" colspan="5">Test Plan</td>
			</tr>
	...
	<c:if test="${empty files}">
		...
		<table border="1px" bordercolor="black" width=80% align="center">
			<tr>
				<td>There is no test plan found</td>
			</tr>
		</table>
	</c:if>
